...
export const analyseImpacte: CaseStudy = {
  ...
  workflow: [
    { title: "Source Code", caption: "Code, SRD & SDDD imported and parsed" },
    { title: "Impact Analysis", caption: "Cross-impact matrix, 4 severity levels" },
    { title: "AI Assistance", caption: "AST parser + local LLM, grounded output" },
    { title: "SDDD Update", caption: "Traceable update, PDF & CSV reports" },
