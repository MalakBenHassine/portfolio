          ...
          {impactPillars.map((pillar, index) => (
            <StaggerItem key={pillar.title}>
              <SpotlightCard
                ...
                className="group flex h-full flex-col p-6 transition-[transform,box-shadow] duration-300 hover:-translate-y-1.5 hover:shadow-[0_24px_60px_-30px_rgb(91_130_255/0.45)] sm:p-7"
              >
